...
class LatestCart extends StatefulWidget {
  LatestCart(
      {Key? key,
  ...
  @override
  State<LatestCart> createState() => _LatestCart();
}
...
class _LatestCart extends State<LatestCart> {
...
void refresh (){
  ...
  void updateDiscount() {
    setState(() {
      ...
      final totalDiscount = otems.fold(
  ...
  Widget build(BuildContext context) {
    ...
    final nakDisplayQuantity = otems.fold(
        0, (sum, otems) => sum + int.parse(otems['quantity'].toString()));

    double totalDiscount = otems.fold(
        0, (sum, otems) => sum + int.parse(otems['discount'].toString()));

    double totalSubtotal = otems.fold(
    0, (sum, otems) => sum + otems['price'] * otems['quantity']);
    ...
    print("total Adam: $nakDisplayQuantity");
                                      ...
                                      ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          for (var i = 0;
                                            ...
                                            if (staffCount == 1) {
                                              var staffID = otems[i]['staffs']
                                                  [0]['staffID'];
                                              var staffInfo =
                                                  otems[i]['staffs'].firstWhere(
                                                (staff) =>
                                          ...
                                          return Dismissible(
                                            ...
                                            onDismissed: (direction) {
                                              ...
                                              deleteItem(otemID).then((_) {
                                                setState(() {
                                                  // Remove the item from the widget tree
                                                  // Example: Remove from a List or a data source
                                                  itemList.removeAt(index);

                                                  print(
                                                      "Dalam dismiss: $otemID");
                                                });
                                              }).catchError((error) {
                                                print(
                                                    ...
                                                    return SizedBox(
                                                      ...
                                                      child: EditItem(
                                                        ...
                                                        updateDiscount:
                                                            updateDiscount,
                                                        updateStaffValues:
                                                            updateStaffValues, refresh: refresh,
                                                      ),
                                                    );
                                                  },
                                                );
