...
class CartStaffSelectItem extends StatefulWidget {
  const CartStaffSelectItem({
    Key? key,
    required this.otems,
    required this.skus,
  ...
  @override
  State<CartStaffSelectItem> createState() => _CartStaffSelectItemState();
}

class _CartStaffSelectItemState extends State<CartStaffSelectItem> {
