...
class ItemForDiscount extends StatefulWidget {
  const ItemForDiscount({
    Key? key,
    required this.otems,
    required this.skus,
  ...
  @override
  State<ItemForDiscount> createState() =>
      _ItemForDiscountState();
}

class _ItemForDiscountState
    extends State<ItemForDiscount> {
